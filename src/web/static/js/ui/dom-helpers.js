...
export const DomHelpers = {
    ...
    /**
     * Get an element by ID, aware of active translation context.
     * @param {string} id - Element ID
     * @returns {HTMLElement} The element
     */
    getElement(id) {
        if (window.currentActiveTranslationId) {
            const specificEl = document.getElementById(`${id}_${window.currentActiveTranslationId}`);
            if (specificEl) return specificEl;
        }
